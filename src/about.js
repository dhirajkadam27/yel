...
function About() {
  ...
  return (
    <div className="aboutpage">
      ...
      <div className='question'>Our Mission</div>
        <div className='description'>To be the foundation of AI innovation by providing high-quality, reliable training data that drives the future of technology.</div>

        
        <div className='question'>Our Story</div>
        <div className='description'>Founded with a vision to make AI more accessible and impactful, Yel AI was born from the realization that high-quality training data is the lifeblood of AI success. Today, we partner with leading enterprises to fuel AI models with data that meets the strictest standards for accuracy, relevance, and ethical compliance.</div>



        <div className='question'>Our Values</div>
        <div className='description'><b>Quality First:</b> We believe in delivering excellence, ensuring that every dataset contributes to real-world success.</div>
        <div className='description'><b>Client-Centric Solutions:</b> Every project we undertake is tailored to the client’s unique needs, industry standards, and goals.</div>
        <div className='description'><b>Innovation Through Integrity:</b> We adhere to ethical AI practices, focusing on transparency, inclusivity, and responsible data management.</div>
        ...
        <div className='question'>Meet the Team</div>
        <div className='description'>Our team is a blend of AI enthusiasts, data scientists, and industry experts, each bringing a unique skill set to deliver high-impact solutions. Together, we’re committed to building a future where AI benefits everyone.</div>
