...
function About() {
  ...
  return (
    <div className="aboutpage">
      ...
      <div className='maintitle'>Industries</div>
      <div className='question'>Healthcare</div>
        <div className='description'>Deliver accurate, life-saving AI models powered by healthcare-specific data.</div>

        
        <div className='question'>Finance</div>
        <div className='description'>Empower financial technology with data designed to optimize algorithms and enhance security.</div>
        ...
        <div className='question'>Automotive</div>
        <div className='description'>Drive advancements in autonomous technology and predictive maintenance with automotive data solutions.</div>

        
        <div className='question'>Technology & Innovation</div>
        <div className='description'>For startups and tech firms breaking new ground, Yel AI provides the data to fuel their next big breakthrough.</div>


        <div className='question'>And many more...</div>
